  ...
  return (
    <section className="relative h-[600px] md:h-[600px] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/research-bg.png"
          alt="Trinity Research Background"
          fill
      ...
      <div className="relative h-full flex items-center">
        <div className="max-w-[1440px] mx-auto w-full px-12">
          <div className="max-w-[720px] text-white">
            <h1 className="font-sans text-6xl md:text-7xl lg:text-[88px] font-bold mb-6 animate-fade-in">
              Trinity Research
            </h1>
            ...
            <p className="text-lg md:text-xl text-gray-200 leading-relaxed animate-fade-in">
              ...
              <br />
              พร้อมโซลูชันทางการเงินครบวงจรที่ออกแบบมาเพื่อเป้าหมายของคุณโดยเฉพาะ
            </p>
          </div>
        </div>
      </div>
