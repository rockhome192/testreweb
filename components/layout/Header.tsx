  ...
  const navigation = [
    {
      ...
      href: "/analysis",
      submenu: [
        { name: "บทวิเคราะห์ล่าสุด", href: "/analysis/latest" },
        { name: "ปัจจัยทางเทคนิค", href: "/analysis/technical" },
        { name: "ปัจจัยพื้นฐาน", href: "/analysis/fundamental" },
        { name: "บทวิเคราะห์รายหลักทรัพย์", href: "/analysis/asset" },
        { name: "บทวิเคราะห์ราย sector", href: "/analysis/sector" },
        { name: "Trinity Quick win", href: "/analysis/quick-win" },
      ],
    },
    {
      name: "บริการ",
      ...
      submenu: [
        ...
        {
          name: "จองซื้อหุ้นสามัญเพิ่มทุน",
          href: "/services/sec-deriv-trading",
        },
    ...
    },
    {
      ...
      href: "/Investor",
      submenu: [
        { name: "รู้จักทรีนิตี้", href: "/Investor/about-trinity" },
        { name: "งบการเงิน", href: "/Investor/financial-statement" },
        { name: "ข่าวแจ้งตลาดฯ", href: "/Investor/new-disclosure" },
        {
          name: "โครงสร้างการเงินและผู้ถือหุ้น",
          href: "/Investor/capital-shareholding",
        },
        { name: "การจ่ายเงินปันผล", href: "/Investor/dividend-payment" },
        { name: "รายงานประจำปี", href: "/Investor/annual-report" },
